...
| Target hook path already occupied by another tool's hook | Refuse, instruct manual integration, no overwrite (FR-014). A hook this installer wrote earlier is refreshed in place instead |
